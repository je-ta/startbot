...
key = re.compile(r"PONSTUKA|ポンツカ|読ん|読む|漫画|本|webサービス|モバイル|モンスターハンター|モンハン|PYTHON|Python|python|電気|電子|パーツ|ノートパソコン|PC|スマホ|タブレット|映画|レビュー|感想|BUMP|bump|Bump|バンプ")
# タグ設定
# タグ名:[タグワード]で設定する。
# タグワードを複数指定することができる。
# ++は必須条件。-0はor条件
...
tagset = {"ポンツカ":["-0PONSTUKA","-0ポンツカ"],"本(漫画含む)":["-0レビュー","-0感想","-1本","-1漫画","-2読む","-2読ん"],"webサービス":["++webサービス"],"モンハン":["-0モンスターハンター","-0モンハン"],"python":["-0PYTHON","-0Python","-0python"],"レビュー(ガッジェット)":["++レビュー","-0モバイル","-0パーツ","-0PC","-0スマホ","-0タブレット","-0電子","-0電気"],"映画":["++映画","-0レビュー","-0感想"],"バンプ":["-0BUMP","-0bump","-0Bump","-0バンプ"]}
# はてなユーザー名
user = 'XXX'
# はてなパスワード
passWord = 'XXX'
